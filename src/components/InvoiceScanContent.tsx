...
interface InvoiceScanContentProps {
  onSaved?: () => void;
  showSavedList?: boolean;
}

const InvoiceScanContent = ({ onSaved, showSavedList = true }: InvoiceScanContentProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {showSavedList && <SavedReceiptsList />}
    </div>
  );
};

export default InvoiceScanContent;
